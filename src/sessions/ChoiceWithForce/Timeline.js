...
const rawStates = [
    ...
    // --- PHASE 1 TO 4 (WISDOM TO KINGDOM) ---
    ...
    // --- ROSH (HEAD): DIRECT LIGHT & REFLECTED LIGHT ---
    ...
    // --- GUF (BODY): SCREEN EXPANSION (VESSELS) ---
    { name: "Guf Expansion: Crown", description: "The Screen expands downwards to create the Crown of the Body (Guf).", action: 'GUF_EXPAND' },
    { name: "Guf Expansion: Wisdom", description: "The Screen expands to create the Wisdom of the Body.", action: 'GUF_EXPAND' },
    { name: "Guf Expansion: Understanding", description: "The Screen expands to create the Understanding of the Body.", action: 'GUF_EXPAND' },
    { name: "Guf Expansion: Beauty", description: "The Screen expands to create the Beauty of the Body.", action: 'GUF_EXPAND' },
    { name: "Guf Expansion: Kingdom", description: "The Screen fully expands to create the Kingdom of the Body.", action: 'GUF_EXPAND' },

    // --- GUF (BODY): LIGHT FILLING (TA'AMIM) ---
    { name: "Guf Light: Crown", description: "The Direct Light drops to fill the Crown of the expanded screen.", action: 'GUF_FILL' },
    ...
    { name: "Guf Light: Kingdom", description: "The Direct Light completely fills the Kingdom of the Body.", action: 'GUF_FILL' }
];
